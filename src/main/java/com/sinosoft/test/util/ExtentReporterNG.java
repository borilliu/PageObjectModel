...
/**
 *com.sinosoft.test.util.ExtentReporterNG.java
 *<p>refer to:https://www.cnblogs.com/peachh/p/12269701.html</p>
...
public class ExtentReporterNG implements IReporter {
	...
	private void init() {
		...
		htmlReporter.config().setDocumentTitle("YPIC自动化测试报告");
		htmlReporter.config().setReportName("YPIC自动化测试报告");
